...
class SAC():
    def __init__(self, config, 
        ...
        # Optimizers
        self.value_optim = Adam(self.value_network.parameters(), lr=self.config.value_lr)
        self.q_optim = Adam(self.q_network.parameters(), lr=self.config.q_lr)
        self.actor_optim = Adam(self.policy.parameters(), lr=self.config.actor_lr)
    def train(self):
